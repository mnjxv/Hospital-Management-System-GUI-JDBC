...
public class AdminRoomView extends JFrame {

    public JTable table;
    public DefaultTableModel model;
    public JTextField txtRoomId;
    public JComboBox<String> cmbRoomCategory;
    public JButton btnAdd, btnUpdate, btnDelete, btnClear, btnRefreshList;

    private static final java.util.List<AdminRoomView> openViews = new java.util.ArrayList<>();

    public static void refreshAllRoomLists() {
        for (AdminRoomView view : openViews) {
            try {
