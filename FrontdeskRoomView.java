...
public class FrontdeskLoginView extends JFrame {
    ...
    public FrontdeskLoginView() {
        setTitle("Hospital Management System - Front Desk Login");
        setSize(480, 560);
    ...
    private void initUI() {
        ...
        JPanel mainPanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                GradientPaint gradient = new GradientPaint(
                    0, 0, new Color(0, 100, 100),
                    0, getHeight(), new Color(0, 140, 140)
                );
        ...
        JLabel titleLabel = new JLabel("Front Desk");
        ...
        btnLogin = createStyledButton("Sign In", new Color(0, 120, 120));
        ...
        JLabel footerLabel = new JLabel("© 2024 Hospital Management System");
        footerLabel.setFont(new Font("Segoe UI", Font.PLAIN, 10));
        footerLabel.setForeground(new Color(150, 170, 200));
