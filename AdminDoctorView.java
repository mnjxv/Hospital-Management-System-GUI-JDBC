...
public class FrontdeskBedView extends JFrame {
    ...
    public JButton btnUpdate, btnClear, btnRefreshRooms;

    public FrontdeskBedView() {
    ...
    public void loadBeds() {
        model.setRowCount(0);
        for (BedModel bed : BedModel.getAll()) {
            model.addRow(new Object[]{
                bed.getFormattedBedId(),
                bed.getRoomId(),
                bed.getStatus()
            });
        }
