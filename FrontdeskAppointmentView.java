...
public class FrontdeskHomepage extends JPanel {
    private JLabel[] countLabels = new JLabel[7];

    private final String[] titles = {
        "Total Patients", "Total Doctors", "Appointments",
        "Available Beds", "Occupied Beds", "Pending Billing", "Total Rooms"
    };
    ...
    public FrontdeskHomepage(String frontdeskName) {
        ...
        JLabel welcomeLabel = new JLabel("Welcome back, " + frontdeskName + "!");
