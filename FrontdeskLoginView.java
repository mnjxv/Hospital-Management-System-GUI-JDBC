...
public class FrontdeskBillingView extends JFrame {
    ...
    public JButton           btnAdd, btnUpdate, btnClear, btnRefreshLists, btnReceipt;
    public JTable            table;
    public DefaultTableModel model;

    // ── Date picker (same style as AdminTreatmentView) ──────────────────────
    ...
    private void buildUI() {
        ...
        model = new DefaultTableModel(
            new String[]{"Billing ID", "Treatment ID", "Total Amount", "Amount Paid",
                         "Payment Status", "Payment Date", "Payment Method"}, 0
        ) {
        ...
        cmbTreatmentId.setFont(new Font("Segoe UI", Font.PLAIN, 13));
        ...
        txtTotalAmount.setFont(new Font("Segoe UI", Font.PLAIN, 13));
        ...
        txtAmountPaid.setFont(new Font("Segoe UI", Font.PLAIN, 13));
        ...
        cmbPaymentStatus = new JComboBox<>(new String[]{" ", "PAID", "PENDING", "PARTIAL"});
        ...
        cmbPaymentMethod = new JComboBox<>(new String[]{" ", "CASH", "INSURANCE", "CARD", "E-WALLET"});
        ...
        cmbPaymentDateFake.setPreferredSize(new Dimension(160, 32));
